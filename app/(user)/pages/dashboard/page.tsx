        ...
        <div>
            ...
            <div className="grid grid-cols-4 gap-4 px-3">
                ...
                <div className="col-span-3 min-w-fit px-2 mt-4">
                    <h3 className={"text-3xl text-bold my-3 text-center underline"}>Hello {JSON.stringify(session?.user?.name)}!</h3>
                    {/*<h3 className={"text-3xl text-bold my-3 text-center underline"}>{JSON.stringify(session)}</h3>*/}
                    ...
                    <div className={"mb-2"}>
                        <ul className={"list-disc text-white"}>
                            <li className={"flex flex-row items-center shadow-md border rounded-lg ring-2 ring-gray-100 my-3 hover:ring-gray-500 hover:border-5 hover:border-slate-300 hover:text-gray-300"}>
                                ...
                                <p className={"text-2xl text-bold"}>Henry Ford</p>
                            </li>
                            <li className={"flex flex-row items-center shadow-md border rounded-lg ring-2 ring-gray-100 my-3 hover:ring-gray-500 hover:border-5 hover:border-slate-300 hover:text-gray-300"}>
                                <span className={"text-lg text-bold mx-3"}>Email</span>
                                <p className={"text-2xl text-bold"}>user@mail.com</p>
                            </li>
                        </ul>
                    </div>
                </div>
